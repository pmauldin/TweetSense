...
def interpolate(datapoints, query):
   ...
   def closeness(x, tau=0.1): ## tau==0 => nearest neighbor; 
      return exp(-x*x/(2*tau))## tau==infinity => unweighted regression
   N = len(datapoints)
...
print(interpolate([(0.0, 1.0), (2.0, 2.0), (4.0, 3.0), (6.0, 4.0)], 1.2))
